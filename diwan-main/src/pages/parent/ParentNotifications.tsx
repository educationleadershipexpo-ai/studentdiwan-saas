...
function getCategory(entity: string, category: string): CategoryTab | null {
  ...
  if (e.includes("fee") || e.includes("payment") || e.includes("invoice") || c === "finance") return "Fees";
...
function getIcon(entity: string, category: string) {
  const e = (entity ?? "").toLowerCase();
  const c = (category ?? "").toLowerCase();
  if (e.includes("fee") || e.includes("payment") || e.includes("invoice") || c === "finance") return <DollarSign className="w-5 h-5" />;
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">
                Parent Portal · Updates and alerts regarding your children
              </p>
            </div>
          </div>
          <button
