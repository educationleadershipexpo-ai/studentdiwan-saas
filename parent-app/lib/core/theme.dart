...
// Palette: Deep Cerulean Blue + Golden Amber  (ui-ux-pro-max / Enterprise SaaS Mobile)
// Primary = institutional trust; Amber = warmth & Arabic golden-dome warmth
class AppColors {
  ...
  static const blue            = Color(0xFF38BDF8);   // Sky Blue
    ...
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(14),
          borderSide: const BorderSide(color: Color(0xFFDDE6F5), width: 1.5),
        ),
