  ...
  Widget build(BuildContext context) => GestureDetector(
    ...
    child: Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text(value, style: TextStyle(fontSize: 19, fontWeight: FontWeight.w900, color: context.t1, height: 1)),
        const SizedBox(height: 3),
        Text(label, style: TextStyle(fontSize: 11, color: context.t3, fontWeight: FontWeight.w600)),
        if (sub != null) ...[
  ...
  Widget build(BuildContext context) => AppBar(
    ...
    leading: GestureDetector(
      ...
      child: Container(
        ...
        child: Icon(Icons.chevron_left_rounded, size: 22, color: context.t1),
      ),
    ),
    title: Text(title),
    actions: actions,
